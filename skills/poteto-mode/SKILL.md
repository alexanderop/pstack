...
- **Keep the Application Independent** (**principle-keep-the-application-independent**). Implementing workflows involving UI, storage, or external services. Let the application own both port contracts, supply adapters externally, and prove behavior with test dependencies.
