...
5. When a PR is requested or required by the established delivery workflow, run **Opening a PR** per component or per safe batch. Otherwise return the verified local result.
