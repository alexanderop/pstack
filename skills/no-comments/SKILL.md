...
1. Spawn `comment-sicko` through the active harness. If that name is unavailable, use its general-purpose agent and require it to read this plugin's `agents/comment-sicko.md` before work. Pass the scope. Do not restate its rules.
