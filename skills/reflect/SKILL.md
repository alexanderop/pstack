...
Where the harness does give you a per-workspace directory (Cursor, Claude Code),
newest-first by real modification time:
...
- Substantive existing-skill edit (a new section, a new pattern table, more than ~10 lines): hand to the harness's skill-authoring tool (`harness/built-ins.md`) and run its draft / test / iterate loop.
