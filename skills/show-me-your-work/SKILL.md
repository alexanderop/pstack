...
At the end of the run, before handing back, check the log told the truth. Read this run's transcript, located per the "Transcripts" section of `harness/<detected>.md`. Scope to the active workspace; never glob across all workspaces, that reads unrelated private chats. Walk the log against what actually happened:
