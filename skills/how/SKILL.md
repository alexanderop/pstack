...
- `model`: your configured how-explorer model (harness default)
- `readonly`: `true`
...
- `subagent_type`: the harness's general-purpose agent (`general-purpose` on Claude Code, `generalPurpose` on Cursor)
- `model`: your configured how-explainer model (harness default)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (harness default), all in a single message.
