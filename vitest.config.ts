...
export default defineConfig({
  test: {
    ...
    projects: [
      ...
      { test: { name: 'vue-replay', include: ['evals/tests/*.replay.test.mjs'], testTimeout: 60_000 } },
      ...(process.env.PSTACK_LIVE_EVALS === '1' ? [
        { test: { name: 'comparison', include: ['evals/tests/*.comparison.test.ts'], testTimeout: 660_000 } },
        { test: { name: 'vue-comparison', include: ['evals/tests/*.vue-comparison.test.ts'], testTimeout: 600_000 } },
